...
public class CommentService {
	...
	public String infoCommentListByExcel(String path, String sheetName) {
		SheetData sheetData = getSheetData(path, sheetName);
		...
		for (RowData data : sheetData.getRows()) {
			String table = getFieldValueStr(data, fieldsIndex, "Table");
			String column = getFieldValueStr(data, fieldsIndex, "Column");
			String div = getFieldValueStr(data, fieldsIndex, "Character");
			String comment = getFieldValueStr(data, fieldsIndex, "Comment");
	...
	public void putCommentListByExcel(String path, String sheetName) {
		...
		for (RowData data : sheetData.getRows()) {
			...
			String column = getFieldValueStr(data, fieldsIndex, "Column");
			String div = getFieldValueStr(data, fieldsIndex, "Character");
			String dataType = getFieldValueStr(data, fieldsIndex, "Data Type");
			String comment = getFieldValueStr(data, fieldsIndex, "Comment");
	...
	private static SheetData getSheetData(String path, String sheetName) {
		...
		try {
			...
			Map<String, Integer> fieldsIndex;
			{
				...
				if (fieldsIndex.isEmpty() || !fieldsIndex.containsKey("Table") || !fieldsIndex.containsKey("Column")
	...
	private static String getFieldValueStr(RowData data, Map<String, Integer> fieldsIndex, String name) {
